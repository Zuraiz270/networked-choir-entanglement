...
- **Init**: Start session: 1. Read AGENTS.md → 2. Check memory → 3. Read git status → 4. Review TODOs.
...
- **Logging**: Update Mistake Log in local AGENTS.md for regressions/errors.
