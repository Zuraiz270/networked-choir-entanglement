...
| **Jun 30** ✓ (mostly done 06-22) | Full pipeline on Tier 1 + Tier 2 + Tier 3                                                       | Tier-1: all 29 videos pose-processed. Tier-2: 28 pieces across 3 datasets. Tier-3: 140-cell latency grid. (Paper-scale 2000-shuffle rerun still pending.) |
