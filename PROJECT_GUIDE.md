...
- **Data**: **Tier-2 Dagstuhl on disk 2026-05-17** (5.1 GB, MD5 verified vs Zenodo). **Tier-1 corpus manifest** at `data/tier1_corpus_manifest.csv` (29 verified URLs in Hacker schema as of 2026-05-19, 4 Hacker seeds re-confirmed + 25 new; stratification 11 Jamulus / 5 Jamulus+Zoom / 4 SoundJack / 9 Zoom-only). First per-singer feature parquets at `data/processed/dagstuhl/LI_QuartetA_Take02/*.parquet`. SHA-256 hashing of Tier-1 binaries deferred to Sprint 3.
...
| **May 15** ✓ (done 05-17, supplemented 05-19, 29 URLs) | YouTube corpus fully curated at 20 to 30 videos                                                         | 29 verified Tier-1 URLs in Hacker schema (4 Hacker seeds re-confirmed + 25 new). Stratification: 11 Jamulus, 5 Jamulus+Zoom, 4 SoundJack, 9 Zoom-only. |
