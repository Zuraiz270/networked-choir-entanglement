...
| **Tier 2 data** (Dagstuhl + ESMUC + ChoralSynth)         | **Dagstuhl on disk 2026-05-17** (5.1 GB, MD5 `82b95faa…` verified vs Zenodo). **ESMUC** (Zenodo `10.5281/zenodo.5848990`, CC BY 4.0, 2.3 GB) and **ChoralSynth** (Zenodo `10.5281/zenodo.10137883`) both confirmed openly downloadable 2026-06-11; scheduled for Sprint-4 Tier-2 ingest. (Earlier "ESMUC proprietary" note was stale, carried from a 2019 paper before its 2022 public release.) |
