...
**Final package day (2026-07-14, corrected 2026-07-16)**: three things landed. First, the cluster rerun completed all 140 envelope and influence-network cells with 2000 circular shifts. The deterministic onset drops remain 56.5% / 65.1% / 75.1%; their correct inference is the paired clean-to-Zoom analysis: all 28 pieces decrease, exact one-sided sign-test p = 3.73 x 10^-9 (`_h1_paired_test.csv`). Second, the H3 first attempt returned a validated null: 1 of 17 analyzable videos significant, with one silent window explicitly excluded. Third, the Jul-23 package and final report are complete: 14 slides plus backup, speaker script, Q&A, PPTX, `report_final.md`, and `output/pdf/networked_choir_final_report.pdf`. Remaining before Jul 23 is rehearsal on the data-bearing presentation laptop, including the fallback slide. Suite at 48 tests.
