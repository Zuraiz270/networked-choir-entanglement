...
**Status VI day (2026-07-09, historical)**: the meeting used the then-current H2 table (0.154 vs 0.139). Final-report audit on 2026-07-16 superseded it with the 2000-shift grid and fixed a rounded-equality p-value bug. Final H2 is 0.162 vs 0.155; Dagstuhl 1/5, ESMUC 1/3, ChoralSynth 0/20 significant.

**Final package day (2026-07-14, corrected 2026-07-18)**: three things landed. First, the cluster rerun completed all 140 envelope and influence-network cells with 2000 circular shifts. The deterministic onset drops remain 56.5% / 65.1% / 75.1%; their correct inference is the paired clean-to-Zoom analysis: all 28 pieces decrease, exact one-sided sign-test p = 3.73 x 10^-9 (`_h1_paired_test.csv`). Second, the H3 first attempt returned a validated null: 1 of 17 analyzable videos significant, with one silent window explicitly excluded. Third, the final course package follows the published rubric: a 17-slide presentation plus 2 backups, 10-12 minute script, Q&A, project-structure diagram, PPTX, `report_final.md`, and `output/pdf/networked_choir_final_report.pdf`. The report follows the required introduction, related work, hypotheses, method, results, discussion, weaknesses, and future-work structure. Remaining before Jul 23 is rehearsal on the data-bearing presentation laptop, including the fallback slide. Suite at 50 tests.
